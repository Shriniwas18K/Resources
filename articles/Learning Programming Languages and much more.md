...
5) Functional Programming: Cpp supports function pointers using std::function and Java supports functional interfaces making Runnable,Predicate,Collector,BiFunction,TriFunction,Records,Vavr library. Python supports first class functions, Callable protocol, dataclasses for the same. It is used in concurrency and event-handling sections.
